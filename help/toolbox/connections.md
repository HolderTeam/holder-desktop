...
Connections helps you think in linked ideas, not just isolated notes.
  ...
  - Move between related cards quickly from the graph.
  - Add explicit relationship types so meaning is preserved over time.
...
Connections shows cards in their immediate intellectual neighbourhood.
  ...
  - Internal [[wiki-style]] links are shown when they resolve to cards in the same project.
